/**
 * Banco de citações do Hero (ROADMAP.md §2.5). Ponto de partida — ~40 frases
 * de domínio público/atribuição comum sobre trabalho, esforço e ofício;
 * ainda não é a curadoria de ~200 com fontes verificadas que o item ❓ do
 * roadmap pede — expandir quando tiver tempo dedicado a isso.
 */
