  ...
  return (
    ...
    <div className="border-b border-accent/50 bg-tint-warn">
      <div className="mx-auto flex max-w-3xl flex-wrap items-center justify-between gap-2 px-4">
        <p className="py-1.5 text-xs text-tint-warn-ink">
        ...
        <Link
          href="/cadastro"
          className="inline-flex min-h-11 items-center text-xs font-medium text-brand underline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-brand"
        >
          Criar minha conta
        </Link>
      </div>
