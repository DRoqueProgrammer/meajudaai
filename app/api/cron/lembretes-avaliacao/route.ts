 ...
 * novo não duplica.
 *
 * Protegido por bearer secret (`CRON_SECRET`), conferido em tempo constante por
 * `segredoConfere` (R-52) — não vaza, pelo tempo de resposta, quantos
 * caracteres do segredo o pedido acertou. O Vercel Cron manda esse header
